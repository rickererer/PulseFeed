...
PulseFeed SHALL maintain a concise project documentation map that separates project startup, product scope, architecture, engineering standards, optimization guidance, UI/UX, and module design.
...
PulseFeed SHALL keep backend, frontend, API, persistence, testing, and documentation conventions in `docs/engineering.md`.
...
PulseFeed module documents SHALL follow a common structure covering responsibilities, APIs, data tables, business rules, testing guidance, and frontend touchpoints.
...
PulseFeed SHALL include OpenSpec project context and a platform-basics capability for future spec-driven changes.
