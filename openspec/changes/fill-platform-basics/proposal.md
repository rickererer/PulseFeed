...
PulseFeed already has product, architecture, engineering, UI/UX, optimization, and module documents, but the information was spread across overlapping files. This change establishes a clean documentation baseline and records the long-lived platform rules in OpenSpec.
...
- `platform-basics`: Project-level documentation, engineering, module, and OpenSpec baseline for future PulseFeed changes.
