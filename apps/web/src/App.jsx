...
const TOKEN_KEY = "pulsefeed.accessToken";
const USER_KEY = "pulsefeed.user";
const PUBLIC_PROFILE_KEY = "pulsefeed.publicProfiles";
...
function LoginPage({ session, onNavigate }) {
  ...
  return (
    <main className="auth-page">
      <section className="auth-visual" aria-label="PulseFeed">
