...
const defaultInteractionExchange = "pulsefeed.interaction"
const defaultActionChangedQueue = "pulsefeed.interaction.action_changed"
const defaultActionChangedRouting = "interaction.action_changed"
const defaultVideoExchange = "pulsefeed.video"
const defaultVideoPublishedQueue = "pulsefeed.video.published"
const defaultVideoEmbeddingQueue = "pulsefeed.video.embedding"
const defaultVideoPublishedRouting = "video.published"
const defaultExposureExchange = "pulsefeed.exposure"
const defaultViewEventRecordedQueue = "pulsefeed.exposure.view_event_recorded"
