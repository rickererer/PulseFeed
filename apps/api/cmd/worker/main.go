...
import (
	...
	applicationembedding "github.com/rickererer/PulseFeed/internal/application/embedding"
	...
	infradatabase "github.com/rickererer/PulseFeed/internal/infra/database"
...
func main() {
	...
	log.Println("pulsefeed worker is running")
	<-ctx.Done()
	log.Println("pulsefeed worker stopped")
}
