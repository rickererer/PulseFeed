...
这份文档给第一次接触 PulseFeed 的读者使用。目标是帮助你建立项目理解框架，并知道代码应该按什么顺序读。

## 1. 先建立项目模型

PulseFeed 是一个短视频 Feed 系统。你可以把它理解成四条主线：
...
```text
exchange: pulsefeed.interaction
queue: pulsefeed.interaction.action_changed
